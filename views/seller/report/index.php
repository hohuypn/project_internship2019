      ...
      <div class="row">
        <div class="col-md-6 col-lg-3">
          ...
          <h3><?php echo $value['quantity_order']; ?></h3>
        <?php endforeach ?>
              </div>
              <div class="row">
                 <p>Hóa đơn đã gửi :   </p>
            <?php foreach ($send_order as $key): ?>
          <h3><?php echo $key['send_order']; ?></h3>
        <?php endforeach ?>
        <br>
              </div>
              <div class="row">
                <p>Hóa đơn đang gửi :   </p>
            <?php foreach ($shipper_order as $dong): ?>
          <h3><?php echo $dong['shipper_order']; ?></h3>
          <?php endforeach ?>
              </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-files-o fa-3x"></i>
            <div class="info">
              <p>Số lượng sản phẩm đã đăng</p>
              <?php foreach ($count_product as $value): ?>
          <h3><?php echo $value['quantity_product']; ?></h3>
        <?php endforeach ?>
            </div>
          </div>
        </div>
