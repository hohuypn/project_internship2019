...
<div class="market-updates">
	<div class="col-md-4 market-update-gd">
		<div class="market-update-block clr-block-1">
			<div class="col-md-8 market-update-left">
				<?php foreach ($registered_user as $value): ?>
					<h3><?php echo $value['quantity_user']; ?></h3>
					<h4>Người dùng đã đăng ký</h4>
					<p>Bao gồm admin và người bán hàng</p>
				<?php endforeach ?>
			</div>
	...
	<div class="col-md-4 market-update-gd">
		<div class="market-update-block clr-block-2">
			<div class="col-md-8 market-update-left">
				<?php foreach ($visited_user as $value): ?>
					<h3><?php echo $value['quantity_user']; ?></h3>
					<h4>Người dùng đã đăng ký</h4>
					<p>Chỉ bảo gồm người dùng</p>
				<?php endforeach ?>
			</div>
			<div class="col-md-4 market-update-right">
				<i class="fa fa-eye"> </i>
		...
		<div class="market-update-block clr-block-3">
			<div class="col-md-8 market-update-left">
				<?php foreach ($ordered as $value): ?>
					...
					<h4>Số lượng sản phẩm đã đặt hàng</h4>
					<p>Other hand, we denounce</p>
				<?php endforeach ?>
			</div>
			<div class="col-md-4 market-update-right">
				<i class="fa fa-shopping-cart fa-2x ordered-count"></i>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
...
<div class="chart-layer-2">
	...
	<div class="col-md-6 chart-layer2-right">
		<div class="prograc-blocks">
			...
			<script src="public/asset/admin/js/bars.js"></script>
