	<div role="tabpanel">
		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="home">
				<form method="POST" action="index.php?controller=seller&action=update&page=admin">
					<?php foreach ($selleredit as $value): ?>
						<div>						
							<label>Họ</label>
						...
						<div class="addCate">
							...
							<input type="submit" name = "editSeller"class="btn btn-primary save-submit" value="Cập nhật">
						</div>
					<?php endforeach ?>
				</form>
			</div>
			<div role="tabpanel" class="tab-pane" id="tab">
				<form method="POST" action="index.php?controller=seller&action=changePass&page=admin">
					<div>						
